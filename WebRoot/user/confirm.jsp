            ...
            <div class="header_container">
                ...
                <div class="top_bar clear">
                    ...
                    <ul class="top_links fr">
                        ...
                        <li class="highlight">
                            <a href="${shop }/user/showCart">购物车</a>
                        </li>
                        <li>
                            <a href="#">欢迎您：${sessionScope.user.uname }</a>
                        </li>
                    </ul>
                    <!--头部小导航结束-->
                    <!-- logo -->
                ...
                <div class="pro-check check ">
	                ...
	                <table class="data-table cart-table" cellpadding="0" cellspacing="0">
						...
						<tr lang="${sorder.product.id}">
							...
							<td class="align_center vline">￥${sorder.price*sorder.numbers}</td>
						</tr>
						</c:forEach>
					</table>
                ...
                <form action="${shop}/forder_save.action" method="post">
	                <div class="person-check check">
	                    ...
	                    <div class="person-checkinner">
	                        <div>
	                        	<label>配送姓名:</label>
	                        	<input type="text" name="name" value="${sessionScope.user.uname  }"/>
	                        </div>
	                        <div>
	                        	<label>联系方式:</label>
	                        	<input type="text" name="phone" value="${sessionScope.user.utel }"/>
	                        </div>
	                        <div>
	                        	<label>区域邮编:</label>
	                        ...
	                        <div>
	                        	<label>配送地址:</label>
	                        	<input type="text" name="address" value="${sessionScope.user.uadd }" />
	                        </div>
	                    </div>
	                </div>
	                <!-- 卖家留言 -->
