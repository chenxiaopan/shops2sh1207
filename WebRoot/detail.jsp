...
<script type="text/javascript">
	$(function() {
		...
		//点击加入购物车时获得用户购买商品的信息，如数量
		$(".add_cart")
				.click(
						function() {
							var num = $("#num").val();
							document.location.href = "${shop}/sorder_addSorder.action?product.id=${product.id}"
									+ "&numbers=" + num;
			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<ul class="top_links fr">
						<li class="highlight"><a href="${shop }/index.jsp">首页</a>
						</li>
						<li><a href="#">我的账户</a>
						</li>
						<li><a href="${shop }/user/showCart.jsp">购物车</a>
						</li>
						<c:choose>
							<c:when test="${session.user==null}">
								<li><a href="#">注册</a>
								</li>
								<li><a href="/s2sh1207/loginForm">登录</a>
								</li>
							</c:when>
							<c:when test="${session.user!=null}">
								<li><a href="#">欢迎您~ ${session.user.uname}</a>
								</li>
								<li><a href="user_logout">退出登录</a>
								</li>
							</c:when>
						</c:choose>
					</ul>
