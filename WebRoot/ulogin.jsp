			...
			<div id="dd" class="action_buttonbar" style="text-align:center;">
				<form method="post" action="user_login">
					<div>
						...
						<input type="text" name="uname" value="<s:property value="uname"/>" />
					</div>
					<div>
						<label for="pass">密码:&nbsp;</label> 
						<input type="text" name="upwd" value="<s:property value="upwd"/>" />
					</div>
					<div>
					<h4><span style="color:red">${sessionScope.error}</span></h4>	  
					</div>
					<div>
